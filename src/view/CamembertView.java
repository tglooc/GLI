...
public class CamembertView extends JComponent
		implements MouseListener, MouseMotionListener, PropertyChangeListener, IVue {
	...
	public CamembertView(Adapter model) {
		this.model = model;
		startingAngle = 0.0;
...
// this main method should actually be placed in another class (it's here just to avoid having multiple files)
	public static void main(String[] a) {
		...
		Adapter model = new Adapter("camembert", "unit");
		// Maybe put some data in the model
		Item i1 = new Item("i1", "d1", 36);
		Item i2 = new Item("i2", "d2", 12);
		Item i3 = new Item("i3", "d3", 7);
		Item i4 = new Item("i4", "d4", 6);
		Item i5 = new Item("i5", "d5", 19);

		model.addItem(i1);
		System.out.println("addin i1");
		model.addItem(i2);
		System.out.println("addin i2");
		model.addItem(i3);
		model.addItem(i4);
		model.addItem(i5);
		model.addItem(i5);
